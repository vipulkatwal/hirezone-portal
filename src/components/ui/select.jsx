...
// Grouping for select items
const SelectGroup = SelectPrimitive.Group

// Value representation in the select
const SelectValue = SelectPrimitive.Value

// Trigger component for the select, handles click and displays selected value
...
// Label for the select item group
